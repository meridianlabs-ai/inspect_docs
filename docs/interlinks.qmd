...
Inspect Docss scans the rendered content on every page for inline code spans and attempts to resolve each one as a symbol in your project's reference index. Two heuristics drive the lookup:
...
Every site built with Inspect Docs is automatically a valid `external_refs` target. When you render your site, Inspect Docs  generates `reference/refs.json` as part of the normal build and publishes it alongside the rest of the site.

Other projects can point at your site's URL and pick up your symbols:
